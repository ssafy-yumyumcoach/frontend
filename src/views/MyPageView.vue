    ...
    <main class="flex-1 p-6 overflow-y-auto bg-zinc-950">
      <div class="max-w-5xl mx-auto space-y-6">
          ...
          <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="flex flex-col items-center gap-4">
              <Avatar class="w-32 h-32">
                ...
                <AvatarFallback class="bg-emerald-500 text-white text-4xl">
                  {{ nickname.charAt(0) }}
                </AvatarFallback>
              </Avatar>
              <div>
                ...
                <label for="profile-image">
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    class="bg-zinc-800 border-zinc-700 text-white hover:bg-zinc-700 cursor-pointer pointer-events-none"
                    onclick="document.getElementById('profile-image').click()"
                  >
                    <!-- Note: pointer-events-none on button because label triggers click -->
        ...
        <div class="bg-zinc-900 border border-zinc-800 rounded-xl p-8 space-y-6">
          ...
          <div class="bg-zinc-800 border border-zinc-700 rounded-lg p-4">
            <p class="text-zinc-400 text-sm">
              💡 챌린지를 완료하면 난이도에 따라 다른 등급의 뱃지를 획득할 수 있어요.
            </p>
          </div>
        </div>
        ...
        <div class="bg-zinc-900 border border-zinc-800 rounded-xl p-8 space-y-6">
            ...
            <div class="grid grid-cols-2 gap-x-8 gap-y-3">
              <div v-for="option in diseaseOptions" :key="option.id" class="space-y-2">
                <div class="flex items-center space-x-3">
                  ...
                  />
                  <label :for="option.id" class="text-zinc-300 cursor-pointer">
                    {{ option.label }}
                  </label>
                </div>
              </div>
          ...
          <div class="space-y-3">
            ...
            <div class="space-y-3">
              <button
                ...
                :class="activityLevel === option.id ? 'bg-emerald-500 border-emerald-500' : 'bg-zinc-800 border-zinc-700 hover:border-zinc-600'"
              >
                <div class="flex items-center justify-between">
                  <div class="space-y-1">
          ...
          <div class="bg-zinc-800 border border-zinc-700 rounded-lg p-4">
            <p class="text-zinc-400 text-sm">
              💡 입력한 정보는 영양·운동 권장량 계산과 AI 추천에 사용돼요.
            </p>
          </div>
