  ...
  <div v-else-if="challenge" class="space-y-6">
    ...
    <div class="max-w-5xl mx-auto space-y-6">
      ...
      <div class="bg-zinc-900 border border-zinc-800 rounded-xl p-8 space-y-6">
        <!-- 라벨 -->
        <div>
          <span class="inline-block text-sm px-3 py-1 rounded-full bg-emerald-500/20 text-emerald-400">
        ...
        <div class="space-y-2">
          ...
          <div class="flex items-center gap-2 text-zinc-300 text-sm">
            ...
            <span class="text-emerald-500"
              >모집 기간: {{ challenge.recruitStartDate }} ~ {{ challenge.recruitEndDate }}</span
            >
          </div>
        </div>
        ...
        <!-- 난이도 선택 영역 -->
        <div
          v-if="challenge.difficultyOptions && challenge.difficultyOptions.length > 0"
          class="space-y-4 pt-4 border-t border-zinc-800"
        >
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              <div class="space-y-2 relative z-10">
                ...
                <div class="text-xs text-zinc-500 pt-1 line-clamp-2">보상: {{ diff.rewardTitleName }}</div>
              </div>
            </button>
          </div>
        ...
        <div class="pt-4">
          ...
          <div v-if="challenge.isJoined && todayStr < challenge.startDate">
            <div class="flex gap-2">
              ...
              <Button
                @click="handleLeave"
                variant="outline"
                class="w-1/3 border-red-500 text-red-500 hover:bg-red-500/10 py-6 text-lg"
              >
                신청 취소
              </Button>
            </div>
          ...
          <div
            v-else-if="
              !challenge.isJoined && todayStr >= challenge.recruitStartDate && todayStr <= challenge.recruitEndDate
            "
          >
          ...
          <div v-else-if="challenge.isJoined && todayStr >= challenge.startDate">
              ...
              <div class="flex justify-between items-center mb-2">
                ...
                <div class="text-right">
                  <span class="text-emerald-400 font-bold block"
                    >{{ formatDecimal(challenge.progressPercentage) }}%</span
                  >
            ...
            <div class="flex flex-col gap-2">
              <Button disabled class="w-full border-zinc-700 text-zinc-400 py-6 text-lg bg-zinc-800"> 참여 중 </Button>
      ...
      <!-- 하단 정보: 참여자 수 등 -->
      <div class="text-center text-zinc-500">현재 {{ challenge.participantsCount }}명이 함께하고 있습니다.</div>
    </div>
  </div>
</template>
